...
try{
  ...
  await writeFile(new URL('../out/browser-results.json',import.meta.url),JSON.stringify({results,invalidPage:true,invalidPDF:true,cancelAndRetry:true,launcher:true,reverseProxyPrefix:true,externalRequests:unexpected,pageErrors:errors,served:[...served]},null,2));
